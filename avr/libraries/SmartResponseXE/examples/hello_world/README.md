...
* You can put the terminal in sleep mode pressing the ON/OFF button on top of the terminal. When in sleep mode, the consumption goes downto around 50µA.
...
## Que fait-il
Ce logiciel test le terminal SMART Response XE
...
* On peut mettre le terminal en veille en appuyant sur le bouton marche/arrêt situé sur le dessus de l'appareil. Lorsqu\'il est en veille, la consommation descend à 50µA environ.
